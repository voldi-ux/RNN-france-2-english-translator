...
def readLangs(lang1, lang2, reverse = False):
    ...
    pairs = [[ normalizeString(lang) for lang in pair.split("\t")] for pair in lines]
...
# l1, l2, pairs  = readLangs("eng", "fra", True)


MAX_LENGTH = 10; # the maximum sentence length allowed to be trained for both languages

# Since the training corpus is ernomous, we will on train on a subset of the data
# and in particular we only want to train on english sentences begining with the following prefixes
